...
- To run the WindowsBuild download this repo on a Windows computer and open WindowsBuild folder , then double click the "Digital Twin" application to run the build.
